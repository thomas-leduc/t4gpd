...
class SoleneSunLibTest(unittest.TestCase):

    def setUp(self):
        gdf = LatLonLib.NANTES
        self.sunLib = SoleneSunLib(gdf)
    ...
    def testGetDayLengthInMinutes(self):
        ...
        _lat, _lon = LatLonLib.fromGeoDataFrameToLatLon()

        _actual = self.sunLib.getDayLengthInMinutes(dt)
        self.assertEqual(822, _actual, 'Test day length in minutes')
    ...
    def testGetRadiationDirection(self):
        ...
        self.assertAlmostEqual(-0.019, result[0], None, 'Test x-component', 1e-3)
        self.assertAlmostEqual(-0.402, result[1], None, 'Test y-component', 1e-3)
        self.assertAlmostEqual(0.915, result[2], None, 'Test z-component', 1e-3)
    ...
    def testGetSolarAnglesInDegrees2(self):
        ...
        self.assertTrue(abs(270 - result[1]) <= 3, 'Test azim at winter solstice)')
    ...
    def testGetSunrise(self):
        ...
        self.assertLess(_delta, 61, 'Test sunrise value')
    ...
    def testGetSunset(self):
        ...
        _delta = (_expected - _actual).seconds

        self.assertLess(_delta, 721, 'Test sunset value')
