...
class DoubleProjectionLibTest(unittest.TestCase):
    ...
    def test_projection_switch(self):
        ...
        for projectionName, expected in PAIRS:
            result = DoubleProjectionLib.projection_switch(
                projectionName)
            self.assertEqual(expected, result.__name__,
                             "Test projection_switch")
    ...
    def test_reverse_projection_switch(self):
        ...
        for projectionName, expected in PAIRS:
            result = DoubleProjectionLib.reverse_projection_switch(
                projectionName)
            self.assertEqual(expected, result.__name__,
                             "Test reverse_projection_switch")
    ...
    def test_isoaire_projection(self):
        ...
        for rp, expected in PAIRS:
            result = DoubleProjectionLib.isoaire_projection(
                self.vp, rp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test isoaire projection", self.epsilon)
    ...
    def test_orthogonal_projection(self):
        ...
        for rp, expected in PAIRS:
            result = DoubleProjectionLib.orthogonal_projection(
                self.vp, rp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test orthogonal projection", self.epsilon)
    ...
    def test_stereographic_projection(self):
        ...
        for rp, expected in PAIRS:
            result = DoubleProjectionLib.stereographic_projection(
                self.vp, rp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test stereographic projection", self.epsilon)
    ...
    def test_reverse_isoaire_projection(self):
        ...
        for pp, expected in PAIRS:
            result = DoubleProjectionLib.reverse_isoaire_projection(
                self.vp, pp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test reverse isoaire projection", self.epsilon)
    ...
    def test_reverse_orthogonal_projection(self):
        ...
        for pp, expected in PAIRS:
            result = DoubleProjectionLib.reverse_orthogonal_projection(
                self.vp, pp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test reverse orthogonal projection", self.epsilon)
    ...
    def test_reverse_stereographic_projection(self):
        ...
        for pp, expected in PAIRS:
            result = DoubleProjectionLib.reverse_stereographic_projection(
                self.vp, pp, size=1)
            self.assertAlmostEqual(expected.distance(
                result), 0, None, "Test reverse stereographic projection", self.epsilon)
