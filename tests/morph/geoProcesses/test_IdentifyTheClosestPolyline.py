...
class IdentifyTheClosestPolylineTest(unittest.TestCase):
    ...
    def testRun1(self):
        ...
        basemap = self.trees1.plot(edgecolor='green', linewidth=0.3)
        self.roads1.plot(ax=basemap, edgecolor='black', linewidth=0.3)
        result.plot(ax=basemap, edgecolor='red', linewidth=0.3)
        plt.show()
        '''
