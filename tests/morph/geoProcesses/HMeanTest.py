...
from t4gpd.morph.geoProcesses.HMean import HMean
...
class HMeanTest(unittest.TestCase):
    ...
    def testRun(self):
        ...
        op = HMean(self.buildings, nRays, maxRayLen, elevationFieldname, background=False)
        ...
        for _, row in result.iterrows():
            ...
            self.assertTrue(0 <= row['hmean'] < 17.0, 'Test hmean attribute values')
