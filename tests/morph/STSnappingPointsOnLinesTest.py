...
class STSnappingPointsOnLinesTest(unittest.TestCase):
    ...
    def setUp(self):
        self.lines = TestUtils.loadDataSet('../data', 'jardin_extraordinaire_path.shp').to_crs('EPSG:2154')
        ...
        '''
        self.points = CSVReader('../data/jardin_extraordinaire_path_wgs84.csv', 'longitude_WGS84',
