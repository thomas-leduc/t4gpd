...
from t4gpd.avidon.STDeploymentOfPVPanels2 import STDeploymentOfPVPanels2
from t4gpd.demos.GeoDataFrameDemos import GeoDataFrameDemos


class STDeploymentOfPVPanels2Test(unittest.TestCase):
    ...
    def testRun(self):
        coverRate, stripWidth = 0.3, 3.2
        azim0, azim1 = (270 - 45, 270 + 45)
        dh, dw = 1.6, 1.0

        result = STDeploymentOfPVPanels2(self.buildings, coverRate=coverRate,
                                         stripWidth=stripWidth, azimuthRange=(azim0, azim1),
        ...
        for _, row in result.iterrows():
            ...
            nMax = coverRate * row.length * stripWidth / (dh * dw)
